 ...
 *
 */
public class GRPSys extends AbstractSys {
    private static final String DEFAULT_TITLE = "【组团系统技术支持邮件提醒】";

    public GRPSys(String content) {
    ...
    public List<String> getRecipientEmails() {
        ...
        recipientEmails.add("fengbaolong@tuniu.com");
