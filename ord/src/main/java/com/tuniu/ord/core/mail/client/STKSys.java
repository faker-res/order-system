 ...
 *
 */
public class STKSys extends AbstractSys {
    private static final String DEFAULT_TITLE = "【D类产品库存系统技术支持邮件提醒】";

    public STKSys(String content) {
    ...
    public List<String> getRecipientEmails() {
        ...
        // recipientEmails.add("haoyabin@tuniu.com");
    ...
    public List<String> getCcEmails() {
        ...
        // ccEmails.add("zhuganggang@tuniu.com");
        return ccEmails;
    }
